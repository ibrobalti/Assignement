...
let MyFriendsName:string[] = ['Danish','Nabeel','Ali','Abbas', 'Zohaib'];
...
let Greetings:string[] = ['Danish','Nabeel','Ali','Abbas', 'Zohaib'];
...
let Favorite_Transp:string[] = ['Bike','Car', 'Bus']
...
let GuestList:String[] = ['Aslam', 'Imran', 'Masam']
